...
require([
  ...
  esriConfig.request.interceptors.push({
    urls: [
        "https://overlord.pgc.umn.edu/arcgis/rest/services/imagery/hma_pgc_mosaic_L8_rgb/MapServer",
        "https://web.overlord.pgc.umn.edu/arcgis/rest/services/fridge/cut_pgc_comm_opt_mono_mosaic_pan_hma/FeatureServer/0",
        "https://web.overlord.pgc.umn.edu/arcgis/rest/services/fridge/md_pgc_comm_opt_mono_mosaic_pan_hma/ImageServer"
    ],
...
function addLayer(layer, checkbox) {
    ...
    document
        .getElementById("EsriBasemapCheckbox")
    ...
    document
    .getElementById("EsriLabelBasemapCheckbox")
    .addEventListener("change", function () {
        if (this.checked) {
        // If the checkbox is checked, show the layer
  ...
  document
    .getElementById("hmaL8rgb")
    .addEventListener("change", function () {
      if (this.checked) {
        // If the checkbox is checked, show the layer
        hmaL8rgb = new ImageryLayer({
